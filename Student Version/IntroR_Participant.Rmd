...
**Exercise 11:** Year was saved as an integer data type (1989 - 2006), but it is a categorical 
...
```{r}
# Exercise 11 code here!

```

**Exercise 12:** Now, verify that `yearF` is viewed as a categorical variable, with the same 
levels as `year`. 
