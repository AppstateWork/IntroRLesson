...
**Exercise 7:** Year was saved as an integer data type (1989 - 2006), but it is a categorical 
...
**Exercise 8:** Now, verify that `yearF` is viewed as a categorical variable, with the same 
levels as `year`. 
